...
public abstract class VehicleService<T extends Vehicle> {
    ...
    protected final Function<Map<String, Object>, T> function = map -> {
        ...
        List<Detail> details = (List<Detail>) map.get("details");
    ...
    protected final List<Detail> simpleDetailsList =
            List.of(new Detail("details1"), new Detail("details2"), new Detail("details3"));
    ...
    protected List<Detail> generateRandomListDetails() {
        return List.of(getRandomDetail(), getRandomDetail(), getRandomDetail());
    }

    private Detail getRandomDetail() {
        return new Detail("details_" + RANDOM.nextInt(100));
    }
